<aside class="sidebar">
    <div class="sidebar-header">
        ...
        <div style="display: flex; flex-direction: column;">
            <span>Dashboard</span>
            <span style="font-size: 0.7rem; padding: 2px 6px; border-radius: 4px; background: rgba(255,255,255,0.1); margin-top: 4px; display: inline-block; width: fit-content; color: var(--text-muted);">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.playground.index') }}" class="nav-item {{ request()->routeIs('admin.playground.*') ? 'active' : '' }}">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20v-6m0 0V4m0 6h8m-8 0H4"></path></svg>
            Playground
        </a>
        <a href="{{ route('admin.api-docs.index') }}" class="nav-item {{ request()->routeIs('admin.api-docs.*') ? 'active' : '' }}">
