...
<section style="padding: 120px 0 80px; max-width: 800px; margin: 0 auto;">
    <article class="glass-card animate-on-scroll">
        <h1 style="margin-top: 0; font-size: 2.5rem; letter-spacing: -0.03em;">Privacy Policy</h1>
        ...
        <div style="color: var(--text-muted); line-height: 1.8; margin-top: 40px; font-size: 1.05rem;">
            ...
            <h3 style="color: var(--text); margin: 32px 0 16px;">1. Information We Collect</h3>
            ...
            <h3 style="color: var(--text); margin: 32px 0 16px;">2. How We Use Your Information</h3>
            ...
            <h3 style="color: var(--text); margin: 32px 0 16px;">3. Data Security</h3>
            ...
            <h3 style="color: var(--text); margin: 32px 0 16px;">4. Contact Us</h3>
            <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:hello@printsilently.com" style="color: var(--accent);">hello@printsilently.com</a>.</p>
        </div>
    </article>
</section>
@endsection
